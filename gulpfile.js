...
gulp.task('html-dist', () => gulp.src('src/html/**.html')
  .pipe(htmlInclude())
  .pipe(gulp.dest('docs')));

gulp.task('images-dist', () => gulp.src('src/images/**/*')
  .pipe(gulp.dest('docs/images')));

gulp.task('css-dist', () => gulp.src('src/styles/**/*.scss')
...
gulp.task('docs', gulp.parallel('html-dist', 'images-dist', 'css-dist', 'js-dist'));
